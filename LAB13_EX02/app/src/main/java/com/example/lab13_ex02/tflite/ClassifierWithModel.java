package com.example.lab13_ex02.tflite;
...
public class ClassifierWithModel {
    ...
    Context context;
    Model model;
    int modelInputWidth, modelInputHeight, modelInputCannel;
    ...
    private Pair<String, Float> classify(Bitmap image, int sensorOrientation) {
